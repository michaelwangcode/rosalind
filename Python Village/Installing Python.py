...
# To start a Python session in the terminal, type 'python' or 'python3'
# Type 'import this' into the terminal to see a paragraph of text
# To exit the session in the terminal, type 'quit()'
